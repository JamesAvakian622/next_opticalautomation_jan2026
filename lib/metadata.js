const siteConfig = {
    ...
    description: 'Transforming businesses with AI-first software development, specialized MERN stack solutions, and premium SEO optimization. We build high-performance web and mobile applications including the MyDeskView Suite for personal and business organization. Delivered solutions are SOC2 Type II and ISO 8601 compliant.',
    shortDescription: 'AI-First Software Development & MyDeskView Solutions',
    compliance: {
        soc2: 'SOC2 Type II compliant — Security, Availability, Processing Integrity, Confidentiality, and Privacy controls verified.',
        soc2Extended: 'SOC2 Type II compliant — Security, Availability, Processing Integrity, Confidentiality, and Privacy controls verified for all delivered solutions.',
