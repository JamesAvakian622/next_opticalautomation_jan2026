const siteConfig = {
    ...
    description: 'Transforming businesses with AI-first software development, specialized MERN stack solutions, and premium SEO optimization. We build high-performance web and mobile applications including the MyDeskView Suite for personal and business organization. For security and production quality we align engineering and operations with AICPA Trust Services Criteria themes (SOC 2), cloud application security assessment expectations (CASA), general-use reporting concepts where a SOC 3 summary would apply, and ISO 8601 for machine-readable timestamps. Independent SOC 2/SOC 3 reports or CASA tier listings are only cited when we publish them.',
    shortDescription: 'AI-First Software Development & MyDeskView Solutions',
    compliance: {
        securityApproach: 'Authentication, access control, encryption in transit, secure SDLC practices, and monitoring suitable for customer-facing cloud software.',
        securityApproachExtended: 'Delivered solutions combine identity-aware routing (e.g. Clerk), tenant-scoped APIs, dependency and configuration hygiene, and encryption in transit—consistent with trust-service and cloud application security expectations. This does not replace an auditor-issued SOC 2, SOC 3, or CASA verification unless separately published.',
        soc2: 'Control activities for software production and delivery are designed against AICPA Trust Services Criteria (Security, Availability, Processing Integrity, Confidentiality, Privacy): access governance, change and release discipline, logging and review, subprocessors, and data handling boundaries. SOC 2 Type I/II examinations and SOC 3 general-use reports are issued only by independent auditors; we describe alignment, not an unqualified attestation, unless a report is public.',
        casa: 'Engineering follows Cloud Application Security Assessment (CASA) program themes for cloud-deployed applications: transport and session security, authentication flows, secure headers and configuration, dependency and vulnerability management, and least-privilege service design. CASA Tier I/II verification is stated only when listed by an authorized assessor.',
        soc3: 'SOC 3 (Trust Services Criteria for General Use) provides a general-distribution summary of controls when an entity completes a SOC engagement. Our documentation and operating practices are structured so they could support SOC 2/SOC 3 narratives; we do not claim an issued SOC 3 report unless one is published.',
        iso8601: 'ISO 8601 (with RFC 3339 profiles where appropriate) is used for APIs, logs, build metadata, and structured content interchange: complete calendar dates, UTC or explicit offsets, and consistent formatting (for example YYYY-MM-DD and YYYY-MM-DDTHH:MM:SSZ) to support auditability and cross-system integration.'
    },
...
/** Shared Schema.org PropertyValue list for SOC 2 / CASA / SOC 3 / ISO 8601 (Organization, Product, etc.). */
export function getComplianceSchemaProperties() {
    const c = siteConfig.compliance;
    return [
        {
            '@type': 'PropertyValue',
            name: 'SOC 2 (Trust Services Criteria alignment)',
            value: c.soc2
        },
        {
            '@type': 'PropertyValue',
            name: 'CASA (cloud application security themes)',
            value: c.casa
        },
        {
            '@type': 'PropertyValue',
            name: 'SOC 3 (general-use reporting context)',
            value: c.soc3
        },
        {
            '@type': 'PropertyValue',
            name: 'ISO 8601 / RFC 3339 timestamps',
            value: c.iso8601
        },
        {
            '@type': 'PropertyValue',
            name: 'Operational security summary',
            value: c.securityApproachExtended
        }
    ];
}
