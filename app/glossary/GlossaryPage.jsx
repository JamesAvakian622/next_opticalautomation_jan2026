...
const glossaryTerms = [
    ...
    { term: "ISO 8601", definition: "An international standard for representing dates and times in a clear, unambiguous format (e.g., YYYY-MM-DDTHH:MM:SSZ), widely used in APIs and data interchange. All date and time values on this site conform to ISO 8601.", category: "Standards" },
    ...
    { term: "CASA (cloud application security)", definition: "Cloud Application Security Assessment program and related criteria for verifying security of cloud applications (e.g. authentication, transport security, configuration). Tier verification is granted by authorized assessors, not self-asserted.", category: "Standards" },
    { term: "SOC 2 (trust services criteria)", definition: "AICPA-defined criteria used in SOC 2 examinations of service organizations, covering themes such as security, availability, processing integrity, confidentiality, and privacy. Third-party SOC 2 Type II reports are issued by auditors; describing those criteria is not the same as holding a report.", category: "Standards" },
    { term: "SOC 3 (general-use report)", definition: "A system and organization controls report for general distribution, summarizing trust service categories when an organization completes a SOC engagement. It complements SOC 2 detail reports; claiming a SOC 3 requires a published auditor-issued report.", category: "Standards" },
