...
const glossaryTerms = [
    ...
    { term: "SOC2 Type II Compliance", definition: "Service Organization Control 2 Type II - A framework for managing customer data based on five trust service principles: Security, Availability, Processing Integrity, Confidentiality, and Privacy. Controls are verified for all delivered solutions.", category: "Standards" },
